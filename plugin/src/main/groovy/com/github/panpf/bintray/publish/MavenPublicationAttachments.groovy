package com.github.panpf.bintray.publish
...
//   @Deprecated         jar.classifier = 'sources'
            jar.archiveClassifier.convention('sources')
...
//   @Deprecated         jar.classifier = 'javadoc'
            jar.archiveClassifier.convention('javadoc')
